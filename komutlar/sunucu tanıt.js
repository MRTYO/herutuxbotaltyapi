...
exports.run = async (client, message, args) => {
  ...
  .addField('Sunucunu tanıtabilmek için beni ekle! (https://is.gd/uZGzPz)')
  .setColor('RANDOM')
 message.channel.sendEmbed(embed);
  ...
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM**:sparkles:  \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin! :flag_tr:  \n\n[🇹🇷 | BLOCKER  - Destek Sunucusu](https://discord.gg/AwaQy2k) \n[Beni Sunucuna Ekleyebilmek İçin Tıklaman Yeterli!](https://is.gd/uZGzPz)'
            }});
  }
};
